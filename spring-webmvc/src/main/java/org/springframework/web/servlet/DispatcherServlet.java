...
public class DispatcherServlet extends FrameworkServlet {
	...
	/**
	 * List of HandlerMappings used by this servlet. 处理器匹配接口
	 */
	@Nullable
	private List<HandlerMapping> handlerMappings;

	/**
	 * List of HandlerAdapters used by this servlet.处理器适配器接口
	 */
	@Nullable
	...
	/**
	 * RequestToViewNameTranslator used by this servlet.请求到视图名的转换器接口
	 */
	@Nullable
	private RequestToViewNameTranslator viewNameTranslator;

	/**
	 * FlashMapManager used by this servlet.FlashMap 管理器接口，负责重定向时，保存参数到临时存储中。代码如下：
	 */
	@Nullable
